...
public class SearchPage  extends BasePage {
    ...
    public SearchPage() {
        ...
        searchElements.put("the jazz singer",By.cssSelector("#center-3-react > div > div > div:nth-child(2) > h3 > div > div > div > div:nth-child(1) > div.event-widgets__nomination-details > div.event-widgets__nominees > div.event-widgets__primary-nominees > span > span > a"));
